...
const TButton = extendVariants(Button, {
  variants: {
    color: {
      "persian-green": [
        "bg-persian-green-600 text-white border-0 !outline-0 !transition-all !gap-2 !items-center",
      ...
      "persian-green-gost": [
        "bg-white text-shark-500 border border-[#C4C4C4] !outline-0 !transition-all !gap-2 !items-center",
